...
* PDF スライド20  
  ・自身の考察  
  　<img src="https://latex.codecogs.com/gif.latex?sigmoid^{\,'}(u)=\left&space;(&space;1-sigmoid(u)&space;\right&space;)\cdot&space;sigmoid(u)" title="sigmoid^{\,'}(u)=\left ( 1-sigmoid(u) \right )\cdot sigmoid(u)" />, <img src="https://latex.codecogs.com/gif.latex?sigmoid\,(0)=\frac{1}{2}" title="sigmoid\,(0)=\frac{1}{2}" />より  
  　<img src="https://latex.codecogs.com/gif.latex?sigmoid^{\,'}(0)=0.25" title="sigmoid^{\,'}(0)=0.25" />  
  　
* PDF スライド28  
  ・自身の考察  
